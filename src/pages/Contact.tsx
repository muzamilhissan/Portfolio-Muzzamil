	...
	const contactInfo = [
		{
			...
			label: 'Email',
			value: 'muzzamilhissan2@gmail.com',
			link: 'mailto:muzzamilhissan2@gmail.com'
		},
		{
			icon: <Phone className="w-5 h-5" />,
			label: 'Phone',
			value: '+92 304 8230247',
			link: 'tel:+923048230247'
		},
		{
	...
	const socialLinks = [
		{
			...
			label: 'GitHub',
			link: 'https://github.com/muzamilhissan'
		},
		{
			icon: <Linkedin className="w-5 h-5" />,
			label: 'LinkedIn',
			link: 'https://www.linkedin.com/in/muzzamil-hissan-9b4862343/'
		},
		{
			icon: <MessageCircle className="w-5 h-5" />,
			label: 'WhatsApp',
			link: 'https://wa.me/923048230247'
		}
	];
