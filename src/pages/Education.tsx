	...
	const educationData = [
		{
			...
			description: "Pursued a Bachelor of Science in Computer Science, gaining in-depth knowledge of algorithms, software engineering, and system design. Actively participated in coding competitions and technical societies."
		},
		{
			school: "The City School Jinnah Campus",
			location: "Pakistan",
			duration: "2018 - 2020",
			degree: "A Levels",
			grade: "Grade: A",
			...
			description: "Completed A Levels with a focus on core sciences, developing strong analytical and problem-solving skills through rigorous coursework in Physics, Chemistry, and Mathematics."
		}
	];
