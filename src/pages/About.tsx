			...
			<div className="grid md:grid-cols-2 gap-8">
				...
				<ScrollAnimation className="space-y-6">
					<div className="space-y-4">
						...
						<p className="text-gray-300 leading-relaxed">
							Currently pursuing my B.S. in Computer Science, I've maintained a strong academic record while actively engaging in real-world projects and internships. This blend of theoretical knowledge and practical experience has shaped my approach to problem-solving and software development.
						</p>
						<p className="text-gray-300 leading-relaxed">
					...
					<ScrollAnimation>
						<div className="pt-4">
							...
							<ul className="list-none space-y-3">
								{["Software Developer", "Computer Science Enthusiast"].map((fact, index) => (
									<motion.li
										key={fact}
					...
					<ScrollAnimation>
						<div className="flex justify-start space-x-4">
							<a
								href="/files/cv_pdf/Muzzamil_CV.pdf"
								target="_blank"
