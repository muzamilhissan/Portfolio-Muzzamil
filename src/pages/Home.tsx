...
const Home = () => {
	...
	const email = 'muzzamilhissan2@gmail.com';
	const whatsappNumber = '923048230247';

	const { data: githubData } = useSWR('https://api.github.com/users/muzamilhissan', fetcher);
				...
				>
					...
					>
						...
						>
							...
							<span className="text-xs sm:text-sm text-gray-400">LinkedIn Connections</span>
						</motion.div>
					</motion.a>
